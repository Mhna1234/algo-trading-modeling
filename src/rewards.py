...
This module provides lightweight reward functions for evaluating strategy performance
in the context of multi-armed bandit allocation. Rewards should be scaled appropriately
